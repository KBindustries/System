    ...
    return (
        <>
            ...
            <div className='flex items-center justify-between'>
                ...
                <Button size="small" onClick={openModal}>Add Student</Button>
            </div>
            {/* //modals */}
            <StudentModal openModal={openModal} openEditModal={openEditModal} getStudent={getStudent} specialties={specialties} closeModal={closeModal} isModalOpen={isModalOpen} />

            <StudentCard openStudentCard={openStudentCard} getStudent={getStudent} closeStudentCard={closeStudentCard} isStudentCardOpen={isStudentCardOpen} />

            <StudentConfirmDelete openModal={openDeleteModal} closeModal={closeDeleteModal} isModalOpen={isDelModalOpen} />
                    ...
                    <TableBody>
                        {filteredData.map((student, i) => (
                            <TableRow key={i}>
                                ...
                                <TableCell>
                                    <span className="text-xs"> {student.specialty_id.level} </span>
                                </TableCell>
                                <TableCell>
                                ...
                                <TableCell>
                                    <span className="text-sm">
                                        <button id={student._id} onClick={() => viewStudentCard(student._id)} className="hover:text-primary">
                                            <svg
                                        ...
                                        <button id={student._id} onClick={() => openEditModal(student._id)} className="hover:text-primary mr-2">
                                            <EditIcon className="w-4 h-4" />
                                        </button>
                                        <button id={student._id} onClick={() => openDeleteModal(student._id)} className="hover:text-primary ">
